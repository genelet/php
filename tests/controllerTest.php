...
"INSERT INTO testing_f (id,a) VALUES (?,?)", array(1, "11"), array(1, "111"), array(2, "22"), array(2, "222"), array(3, "33"), array(3, "333"), array(4, "444"), array(5, "555"));
		...
		$this->assertIsObject($err);
		$this->assertEquals(200, $err->error_code);
		$this->assertEquals('{"success":true,"incoming":{"action":"edit","id":4},"data":[{"x":"ddd","y":"www","z":"1","id":"4","id_md5":"WBDuVepn54OOmgFH5TllK3ccX0Euok_SBby2pJEBjqc"}],"included":{"csrf_token":"AAAAAE_CbxN0zA2c7g-Jw_sYoPJLwhnhRNYtBgUc0tHtV9rn","cache_url":"\/bb\/m\/t\/4.json","json_url":"\/bb\/m\/json\/t?action=edit"}}', $err->error_string);
